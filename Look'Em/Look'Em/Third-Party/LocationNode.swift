...
open class LocationAnnotationNode: LocationNode {
    ...
    public init(location: CLLocation?, view: PersonARView) {
        self.image = UIImage()
    ...
    public init(location: CLLocation?, width: CGFloat, height: CGFloat, texture: UIImage) {
        self.image = UIImage()
        
        let plane = SCNPlane(width: width/100, height: height/100)
